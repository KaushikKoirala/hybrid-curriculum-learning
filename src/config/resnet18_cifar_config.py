def get_resnet18_cifar_config(run_id: str = '', lerac_epochs: int = 5, blur_epochs: int = 20, eta_min: float = 2e-8):
    """
    Configuration for ResNet-18 on CIFAR-10 with hybrid curriculum learning
    """
    config = {
